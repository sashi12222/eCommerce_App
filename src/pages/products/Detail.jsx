...
const Detail = () => {
    ...
    if(loading) return  <div role="status" className="mt-10 flex items-center justify-center">
  ...
  return (
    <section className="py-12">
      <div className="max-w-screen-xl mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-around ">
          <img src={product.url ?? jacket} alt="" className="md:w-1/2" />
          <div className="md:w-1/2">
          <span className='text-xs bg-green-500 rounded-xl px-2 text-white absolute  '>{product.category}</span>
    ...
    <span className='text-xl mr-1'>
        ${Math.floor(product.price*0.8)}</span> 
        <span className='line-through text-slate-300 text-sm'>${product.price}</span>
